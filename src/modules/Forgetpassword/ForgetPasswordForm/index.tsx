...
const ForgetPasswordForm = () => {
  ...
  return (
    ...
    >
      {!showSuccess ?
        <Stack>
          <Typography variant="headlineLargeSemiBold" mb={2}>{t('title.resetPassword')}</Typography>
          <Typography variant="headlineSmall" color={theme.palette.grey[600]} mb={2}>{t('message.resetPassword')}</Typography>
        ...
        :
        <Stack>
          <Typography variant="headlineLargeSemiBold" color={theme.palette.success.light} mb={2}>{t('status.resetPasswordSuccess')}</Typography>
