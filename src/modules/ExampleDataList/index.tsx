...
import { Box, Button, CircularProgress, Divider, List, ListItem, Stack, styled, Typography } from "@mui/material";
          ...
          <Stack padding="2rem" position={"relative"}>
            <Stack spacing={2.4}>
              <Stack direction="row" alignItems="center">
                <IconAiInterpret />
                <TypographyPageHeadline variant="headerExtraLargeBold" marginLeft="20px">
