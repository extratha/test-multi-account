      ...
      <ContentContainerWrapper>
        {isGetExampleDataLoading ? (
          ...
          <Stack padding="2rem" position={"relative"}>
            ...
            >
              {exampleData &&
                exampleData.map((data: ExampleData, index: number) => {
                  return (
                    <ListItem
                      key={index}
                      sx={{
                    ...
                    >
                      ...
                      >
                        <Stack spacing={1}>
                          ...
                          <Typography variant="titleLargeSemiBold">{data.caseName}</Typography>
                        ...
                        <Stack minWidth={"48%"} margin={"0 0 0 auto"}>
                          ...
                          >
                            ...
                            <Typography variant="labelLargeSemiBold">{data.aiModelVersion}</Typography>
                          </Stack>
                        </Stack>
                      </Stack>
                    </ListItem>
